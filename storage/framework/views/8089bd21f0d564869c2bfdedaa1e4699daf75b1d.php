        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            <div>
                ...
                <?php $__currentLoopData = $materias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $materia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('materia-infos', ['id' => $materia -> id, 'professor' => $materia -> professor_id])); ?>" style="font-size: 20px; color:#e2e8f0"><?php echo e($materia -> nome); ?></a> <br>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                
                <form action="<?php echo e(route('addMateria')); ?>" method="post" accept-charset="UTF-8">
...
<?php /**PATH /var/www/resources/views/materias.blade.php ENDPATH**/ ?>